...
namespace RadarMonitor.ViewModel
{
    ...
    public class RadarMonitorViewModel : INotifyPropertyChanged
    {
        ...
        // UDP Clients
        private List<Cat240UdpClient> _udpClients = new()
        {
            null, null, null, null, null
        };
        ...
        public void CaptureCat240NetworkPackage(int radarId, string radarIp, int radarPort, string localIp)
        {
            ...
            var client = new Cat240UdpClient(radarId, localIp, radarPort);
            //var client = new SimpleUdpClient(radarId, radarIp, radarPort);
            client.SetupMulticast(true);
            client.DestinationIp = radarIp;
